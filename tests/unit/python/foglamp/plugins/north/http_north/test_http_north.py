...
def test_plugin_send():
    ...
    with patch.object(http_north.http_north, '_send', return_value=asyncio.ensure_future(mock_coro())) as patch_send:
    ...
    calls = [call({'asset_code': 'fogbench/temperature', 'readings': [
                {'read_key': '31e5ccbb-3e45-4038-95e9-7920834d0852', 'user_ts': '2018-02-26 12:12:54.171949+00',
                 'reading': {'ambient': 7, 'object': 28}}]}),
             call({'asset_code': 'fogbench/wall clock', 'readings': [
                 {'read_key': '277a6ac9-4351-4807-8cfd-a709d6c346cd', 'user_ts': '2018-02-26 12:12:54.172166+00',
                  'reading': {'tick': 'tock'}}]})]
